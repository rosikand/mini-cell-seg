...
for subdir in sub_dirs:
	...
	img_file = im_files[0]
	image = cv2.imread(img_file, 0)  # 0 means grayscale
	...
	mask_arrays = []
	spliced_segment = np.zeros((1, 28, 28), dtype=float)
	...
	# # plot to visualize 
	# plot_numpy_img(jax_img_array, False)
	# plot_numpy_img(jax_mask_array, False)
	# break

# pickle up dataset 
out_file = open("small_set.pkl", "wb")
